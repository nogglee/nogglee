...
const PORTFOLIO_DATA = [
	...
	},
	{
		id: 3,
		title: 'POS 시스템 개발',
		description: '상품·재고·판매·포인트까지 모두 관리할 수 있는<br>서버리스 기반 매장 운영 솔루션을 제작했습니다.',
		content: '<strong>프로젝트 개요</strong><br>오프라인 매장에서 사용할 수 있는 웹 기반 POS 시스템을 기획부터 개발까지 진행했습니다.<br>상품 등록부터 판매·재고·매출 관리는 물론 고객별 포인트 적립 및 할인 적용까지 가능합니다.<br><img src="/m/a/p/3-1.png"><img src="/m/a/p/3-2.png"><img src="/m/a/p/3-3.png"><br><strong>주요 기능</strong><br><ul><li>상품/재고 관리<ul><li>상품별 카테고리 분류</li><li>수량 입력 및 잔여 수량 실시간 반영</li><li>가격 변경 및 옵션 설정 기능</li></ul></li><li>판매 관리 (POS 화면)<ul><li>상품 선택 기반 자동 합산</li><li>결제수단(카드/현금/포인트) 별 처리</li><li>판매 내역 정리 및 실시간 매출 반영</li></ul></li><li>고객 관리<ul><li>고객별 포인트 적립</li><li>구매 이력 관리 및 반복 구매 분석</li></ul></li><li>포인트 시스템<ul><li>결제 시 포인트 사용/적립 기능 포함</li><li>포인트 이력 및 누적/차감 내역 확인 가능</li></ul></li><li>상품 관리 인터페이스<ul><li>대량 상품 등록 및 수정</li><li>카테고리 드롭다운, 검색 및 정렬 기능</li></ul></li></ul>',
		type: 'apps',
		video: '',
		image: '/m/a/p/3.svg'
	},
	{
		...
		content: '<strong>프로젝트 개요</strong><br>내부 보안 정책으로 인해 Notion 사용이 어려운 고객사를 위해,<br>노션과 구글시트를 양방향으로 연동하여 입력한 데이터를 기반으로<br>타임라인 생성 자동화 기능까지 구현했습니다.<br><img src="/m/a/p/4-1.png"><img src="/m/a/p/4-2.png"><img src="/m/a/p/4-3.png"><img src="/m/a/p/4-4.png"><br><strong>주요 기능</strong><br><ul><li>노션 → 구글시트 데이터 전송<br>노션 데이터베이스의 데이터를 추출하여 구글시트에 맞춘 포맷으로 자동 삽입합니다.</li><li>구글시트 → 노션 데이터 전송<br>구글시트에서 입력한 데이터를 스크립트 실행으로 노션 데이터베이스에 자동 삽입합니다.</li><li>타임라인 생성 자동화<br>타임라인 생성을 위한 스크립트를 구글시트에 추가하여 자동으로 타임라인을 생성합니다.</li><li>특정 시간 자동 업데이트<br>특정 시간에 자동으로 노션 데이터베이스의 데이터를 업데이트합니다.</li><li>노션 하위 데이터베이스 접근<br>API를 사용하여 노션 데이터베이스의 페이지 내부 콘텐츠를 업데이트 할 수 있고,<br>노션 데이터베이스의 하위 페이지를 접근하여 파일 업로드를 실행합니다.</li></ul>',
		type: 'tools',
		video: '',
		image: '/m/a/p/4.svg'
	},
